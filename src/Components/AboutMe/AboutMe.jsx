            ...
            <div className="container">
                <div className="row">
                    <p className='fs-4 fw-lighter p-3 lh-lg custom-font'>
                        ...
                        My favorite pastime is playing cricket, a sport I’m truly passionate about. It keeps me active, sharpens my focus, and teaches me the value of teamwork and strategy.<br />
                        ...
                        These hobbies not only provide a balance to my professional life but also contribute to my overall growth as a developer and individual, allowing me to bring fresh perspectives and ideas to my work.<br />
                    </p>
                </div>
            </div>
        </div>
